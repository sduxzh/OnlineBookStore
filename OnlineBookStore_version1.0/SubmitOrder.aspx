...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <!--绑定书籍图片-->
                        <asp:ImageButton ID="ImageButton_Pictrue" runat="server" CssClass="ImageButton_Pictrue" ImageUrl='<%# Bind("BookImage") %>' Style="z-index: 1" />
                        <!--绑定图书名字-->
                        <asp:LinkButton ID="LinkButton_Name" runat="server" CssClass="LinkButton_Name" Text='<%# Bind("BookName") %>'></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <!--绑定图书单价-->
                        <asp:Label ID="Label_SinglePrice1" runat="server" CssClass="Label_SinglePrice1" Text='<%# Bind("SinglePrice") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:TextBox ID="TextBox_SingleAmount" runat="server" TextMode="Number" CssClass="TextBox_SingleAmount"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <!--绑定折扣-->
                        <asp:DropDownList ID="DropDownList_Discount" runat="server" CssClass="DropDownList_Discount" Text='<%# Bind("Discount") %>'></asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <asp:Panel ID="Panel_UserMessage" runat="server" CssClass="Panel_UserMessage">
        ...
        <!--提交订单按钮-->
        <asp:Button ID="Button_SaveMessage" runat="server" CssClass="Button_SaveMessage" Text="提交订单" />
    </asp:Panel>
