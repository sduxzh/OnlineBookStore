...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="P_OrderShow" runat="server" CssClass="P_OrderShow">
        <!--订单gridview-->
        <asp:GridView ID="grvOrderInfo" runat="server" AllowPaging="True" AllowSorting="True" CssClass="GV_OrderShow" AutoGenerateColumns="False" HorizontalAlign="Center">
            <Columns>
                <asp:BoundField HeaderText="订单号" SortExpression="订单号" HeaderStyle-CssClass="GV_Title1" ItemStyle-CssClass="GV_Item1"></asp:BoundField>
                <asp:BoundField HeaderText="用户名" SortExpression="用户名" HeaderStyle-CssClass="GV_Title2" ItemStyle-CssClass="GV_Item2"></asp:BoundField>
                <asp:BoundField HeaderText="下单时间" SortExpression="下单时间" HeaderStyle-CssClass="GV_Title3" ItemStyle-CssClass="GV_Item3"></asp:BoundField>
                <asp:BoundField HeaderText="总价(元)" SortExpression="总价" HeaderStyle-CssClass="GV_Title4" ItemStyle-CssClass="GV_Item4"></asp:BoundField>
                <asp:BoundField HeaderText="有效" SortExpression="有效" HeaderStyle-CssClass="GV_Title5" ItemStyle-CssClass="GV_Item5"></asp:BoundField>

                <asp:TemplateField ShowHeader="False" HeaderStyle-CssClass="GV_Title6" ItemStyle-CssClass="GV_Item6">
                    <ItemTemplate>
                        <!--选择button-->
                        <asp:LinkButton ID="BChoose" runat="server" CssClass="ChooseButton" OnClick="cmdOrderChoose_Click">选择</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
    ...
    <asp:Panel ID="P_OrderDetail" runat="server" CssClass="P_OrderDetail">
        ...
        <asp:GridView ID="grvOrderDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="GV_Detail" Font-Overline="False" HorizontalAlign="Center" PageSize="3">
            <Columns>
                <asp:BoundField HeaderText="书号" HeaderStyle-CssClass="GV_DTitle1" ItemStyle-CssClass="GV_DItem1"></asp:BoundField>
                <asp:BoundField HeaderText="书名" HeaderStyle-CssClass="GV_DTitle2" ItemStyle-CssClass="GV_DItem2"></asp:BoundField>
                <asp:BoundField HeaderText="单价" HeaderStyle-CssClass="GV_DTitle3" ItemStyle-CssClass="GV_DItem3"></asp:BoundField>
                <asp:BoundField HeaderText="数量" HeaderStyle-CssClass="GV_DTitle4" ItemStyle-CssClass="GV_DItem4"></asp:BoundField>
            </Columns>
            <EditRowStyle HorizontalAlign="Center" />
